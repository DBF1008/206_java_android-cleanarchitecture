...
public class ErrorMessageFactoryTest extends AndroidTestCase {
  ...
  public void testBadServerResponseErrorMessage() {
    String expectedMessage = getContext().getString(R.string.exception_message_bad_response);
    String actualMessage = ErrorMessageFactory.create(getContext(),
        new BadServerResponseException());
